...
export function Feedback(props) {
    ...
    if (props.feedbackType === "thumbs" && props.optionalTextLabel === null) {
        ...
        return (<ThumbsWithQualiFeedback submitFeedback={submitFeedback} optionalTextLabel={props.optionalTextLabel} reviewOnPositive={props.reviewOnPositive} disableWithScore={props.disableWithScore} align={props.align}/>)
    } else if (props.feedbackType === "thumbs" && props.optionalTextLabel !== null && props.maxTextLength) {
        return (<ThumbsWithQualiFeedback submitFeedback={submitFeedback} optionalTextLabel={props.optionalTextLabel} maxTextLength={props.maxTextLength} reviewOnPositive={props.reviewOnPositive} disableWithScore={props.disableWithScore} align={props.align}/>)
        ...
        return (<FacesWithQualiFeedback submitFeedback={submitFeedback} optionalTextLabel={props.optionalTextLabel} reviewOnPositive={props.reviewOnPositive} disableWithScore={props.disableWithScore} align={props.align}/>)
    } else if (props.feedbackType === "faces" && props.optionalTextLabel !== null && props.maxTextLength) {
        return (<FacesWithQualiFeedback submitFeedback={submitFeedback} optionalTextLabel={props.optionalTextLabel} maxTextLength={props.maxTextLength} reviewOnPositive={props.reviewOnPositive} disableWithScore={props.disableWithScore} align={props.align}/>)
